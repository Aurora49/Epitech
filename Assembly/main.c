...
** Last update Sun Mar 30 20:58:14 2014 Desmars
*/
...
int		main(int ac, char **av)
{
  ...
  /* char	*tab2; */
  /* tab2 = malloc(50 * sizeof(char)); */
  /* tab2 = memset(tab2, 2, 10); */
  /* printf("TRUE => %d \n MINE => %d \n", tab, tab2); */
  printf("MEMSET OK \n");
  ...
  char		*bob = "azerty toto bobo";
  char		*bob2 = "toto";

  /* printf("TRUE => %s \nMINE => %s \n", strstr(bob, bob2), my_strstr(bob, bob2)); */
  printf("STRSTR  OK \n");
  

  /* printf("TRUE => %d \nMINE => %d \n", strcspn(bob, bob2), my_strcspn(bob, bob2)); */
  printf("STRCSPN OK \n");

  /* printf("TRUE => %s \nMINE => %s \n", strpbrk(bob, bob2), my_strpbrk(bob, bob2)); */
  printf("STRPBRK OK \n");
